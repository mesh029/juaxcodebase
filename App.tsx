      ...
      if (activeTab === 'activity') {
        return (
          <ActivityTab
            ...
            setLaundryOrders={setLaundryOrders}
            bnbBookings={bnbBookings}
            listingRequests={listingRequests}
            activityFeedItems={activityFeedItems}
            activitySection={activitySection}
            setActivitySection={setActivitySection}
            activitySocketConnected={activitySocketConnected}
            activityBellCount={activityBellCount}
      ...
      if (activeTab === 'profile') {
        return (
          <ProfileTab
            ...
            signOut={signOut}
            laundryOrders={laundryOrders}
            rentalSubscriptionActive={rentalSubscriptionActive}
            activeSubscriptionPlan={activeSubscriptionPlan}
            activeSubscriptionExpiresAt={activeSubscriptionExpiresAt}
            subscriptionPlans={subscriptionPlans}
            themePreference={themePreference}
            setThemePreference={setThemePreference}
            setSubscriptionSheetOpen={setSubscriptionSheetOpen}
            goToKejaRentals={() => {
              setActiveTab('home');
              setActiveSegment('bnbs');
              setActiveService('bnbs');
